...
<html lang="en">
  ...
  <body>
        ...
        <div class="site-header__middle">
          <nav class="nav">
            <ul class="nav__wrapper">
  		      <li class="nav__item"><a href="viewfaculty">View Profile</a></li>
              <li class="nav__item"><a href="changefacultypwd">Change Password</a></li>
              
              <li class="nav__item"><a href="viewallocatedcourses">View Courses</a></li>
    ...
    <h1 align=center>Welcome&nbsp;<c:out value="${funame}"></c:out></h1>
    </center>
